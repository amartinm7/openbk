...
class Solution {
  ...
  public String solution(String S) {
    ...
    // the 'a' represent a position in the ASCII code
    // 'b' - 'a' substract the code in ASCII table, so 100 - 99 is 1, which is the position in the array
    // 'c' - 'a' substract the code in ASCII table, so 101 - 99 is 2, which is the position in the array
